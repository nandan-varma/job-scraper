...
const RULES: Array<{ category: DepartmentCategory; pattern: RegExp }> = [
  ...
  { category: "clinical", pattern: /\bclinical\b|nursing|patient|caregiver|behavior technician|medical\b/i },
  { category: "data", pattern: /\bdata (science|engineering|analytics)\b|\bdata\b$|machine learning|\bml\b|analytics\b/i },
  { category: "design", pattern: /\bdesign\b|\bux\b|\bui\b|creative\b/i },
  { category: "product", pattern: /\bproduct\b/i },
  { category: "people", pattern: /\bpeople\b|human resources|\bhr\b|talent\b|recruiting|recruitment/i },
  { category: "legal", pattern: /\blegal\b|compliance|regulatory/i },
  { category: "finance", pattern: /\bfinance\b|accounting|treasury|\bfp&a\b|^tax$/i },
  { category: "customer_success", pattern: /customer (success|support|experience|service)|\bsupport\b/i },
  { category: "marketing", pattern: /marketing|\bbrand\b|communications|\bpr\b|content\b|\bgrowth\b/i },
  {
    category: "sales",
    pattern: /\bsales\b|account executive|account management|business development|\bbd\b|\brevenue\b|partnerships|\bgtm\b|go.?to.?market|commercial\b/i,
  },
  {
    category: "engineering",
    pattern: /engineer|developer|\bswe\b|software (dev|engineering)|\br&d\b|research\s*(&|and)?\s*development|\bresearch\b|hardware\b|information technology|^it$|technology\b|dev.?ops|infrastructure|technical staff|\bsecurity\b|quality assurance/i,
  },
  {
    category: "manufacturing",
    pattern: /manufacturing|production|warehouse|supply chain|reconditioning|field operations|logistics|\bretail\b|\bstores?\b|in-store/i,
  },
  { category: "executive", pattern: /executive|leadership|\bc-suite\b|^chief\b|\bceo\b/i },
  { category: "operations", pattern: /\boperations\b|\bops\b/i },
];

export function categorizeDepartment(department: string | null): DepartmentCategory | null {

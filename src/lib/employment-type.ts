...
const RULES: Array<{ category: EmploymentTypeCategory; pattern: RegExp }> = [
 ...
 { category: "contract", pattern: /contract|freelance|befristet/i },
 { category: "temporary", pattern: /seasonal|\btemp\b|temporary/i },
 { category: "part_time", pattern: /part.?time|teilzeit/i },
 {
  category: "full_time",
  ...
  // Temps plein / Plein temps = French "full-time", Vollzeit = German
  // "full-time") — translating an exact known term isn't a guess the way
  // inferring semantics from an ambiguous phrase would be.
  pattern:
   /full.?time|^standard$|^permanent$|^cdi$|正社員|tiempo completo|temps plein|plein temps|vollzeit/i,
 },
];
